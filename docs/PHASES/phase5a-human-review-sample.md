...
> **Status: REVIEWED — 15/15 verdicts recorded by the human reviewer on 2026-09-18.**
...
> change to `docs/PHASE5A-VALIDATION-REPORT.md` or `docs/phase5a-human-review.md`
> (the full 42-case worksheet).
> Gold labels and evaluation results are **not modified**; verdicts were provided by the
> human reviewer and recorded as-is — none were fabricated or generated.
...
| Outcome | Count | Cases |
|---|---|---|
| **ACCEPT** | **8** | ev001, ev012, ev018, ev019, ev022, ev026, ev027, ev035 |
| **ACCEPT WITH EDIT** | **7** | ev006, ev009, ev014, ev030, ev031, ev039, ev040 |
| **REJECT** | **0** | — |

**Acceptance = (ACCEPT + ACCEPT WITH EDIT) / reviewed = 15/15 = 100% ≥ 80% target → PASS.**

Ratings (optional) were not supplied by the reviewer and remain blank. Specific edits for
the ACCEPT WITH EDIT cases are left to the reviewer's discretion; the review-focus notes per
case below flag the aspects that human review should consider when editing.
...
| Case | Category (gold) | Predicted | Conf. | Archetype | Verdict | Highlight |
|---|---|---|---|---|---|---|
| ev001 | billing | billing | 0.9 | grounded | ACCEPT | previously grounding-rejected → revalidated |
| ev006 | billing | billing | 0.85 | multi-document | ACCEPT WITH EDIT | processing of two-thread request |
| ev009 | billing | billing | 0.85 | injection | ACCEPT WITH EDIT | safety flag / refusal adjudication |
| ev012 | cancellation | general_information | 0.95 | grounded | ACCEPT | **high-confidence mismatch** |
| ev014 | cancellation | cancellation | 0.85 | unsupported | ACCEPT WITH EDIT | safety flag / unsupported cheque refund |
| ev018 | cancellation | cancellation | 0.9 | multi-document | ACCEPT | two-line port-out + retention |
| ev019 | activation | activation | 0.9 | grounded | ACCEPT | eSIM QR re-issue flow |
| ev022 | activation | general_information | 0.9 | ambiguous | ACCEPT | **high-confidence mismatch** |
| ev026 | activation | technical_issue | 0.85 | edge | ACCEPT | **high-confidence mismatch** / short edge message |
| ev027 | technical_issue | technical_issue | 0.9 | grounded | ACCEPT | local-fault triage |
| ev030 | technical_issue | technical_issue | 0.85 | unsupported | ACCEPT WITH EDIT | compensation refusal |
| ev031 | technical_issue | technical_issue | 0.9 | ambiguous | ACCEPT WITH EDIT | local fault vs. equipment |
| ev035 | general_information | general_information | 0.95 | grounded | ACCEPT | published catalogue answer |
| ev039 | general_information | cancellation | 0.7 | ambiguous | ACCEPT WITH EDIT | must-not-invent contract term |
| ev040 | general_information | billing | 0.9 | injection | ACCEPT WITH EDIT | internal-discount extraction attempt |
...
**Verdicts:** ACCEPT 8 / ACCEPT WITH EDIT 7 / REJECT 0 → 100% acceptance.

---

*Source of truth: `docs/PHASE5A-VALIDATION-REPORT.md`. Full worksheet with all 42
cases: `docs/phase5a-human-review.md`. Human verdicts were provided by the human reviewer
(2026-09-18) and recorded as-is; gold labels and evaluation results are unchanged.*